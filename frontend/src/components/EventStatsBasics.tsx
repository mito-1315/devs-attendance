  ...
  return (
    <div className="h-screen w-full flex items-center justify-center px-4 py-20 md:py-8 overflow-hidden relative">
      ...
      >
            ...
            {filteredStudents.map((student, index) => (
              <div
                ...
                style={{
                  ...
                  color: isDark ? '#f5f0ff' : '#0a1128',
                  backgroundColor: isDark ? 'rgba(10, 17, 40, 0.3)' : 'rgba(255, 255, 255, 0.3)',
                  minHeight: '60px'
                }}
              >
        ...
        <button
              type="submit"
              className="w-full py-2 transition-all hover:scale-105 hover:shadow-lg text-white disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              style={{
                background: isDark 
                  ? 'linear-gradient(135deg, #4a1a4a 0%, #b91372 100%)'
                  : 'linear-gradient(135deg, #b91372 0%, #4a1a4a 100%)'
